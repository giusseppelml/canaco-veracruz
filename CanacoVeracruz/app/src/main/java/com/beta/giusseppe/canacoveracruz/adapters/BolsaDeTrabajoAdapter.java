...
public class BolsaDeTrabajoAdapter extends RecyclerView.Adapter<BolsaDeTrabajoAdapter.ViewHolder> {
    ...
    public BolsaDeTrabajoAdapter(List<Contenido> conten, int layout, OnItemClickListener listener)
    {
        this.conten = conten;
        this.layout = layout;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(v);
            TextViewTitulo = (TextView)itemView.findViewById(R.id.cardViewBolsaTitulo);
            TextViewDescripcion = (TextView)itemView.findViewById(R.id.cardViewBolsaDescripcion);
            TextViewVerMas = (TextView)itemView.findViewById(R.id.cardViewBolsaVerMas);
            ImageViewPortada = (ImageView)itemView.findViewById(R.id.cardViewBolsaImagen);
        }
