...
import com.beta.giusseppe.canacoveracruz.adapters.EventosAdapter;
...
public class EventosFragment extends Fragment {
    ...
    private static final String VISITANTE = Api.URL_READ_CONTENIDO_CATEGORIA_PRIVADO+EVENTOS+Api.URL_READ_CONTENIDO_PRIVADO_ESTADO+PUBLICO;
    private static final String LOGUEADO = Api.URL_READ_CONTENIDO+EVENTOS;
    String verificar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewEventos);
        sinRed = (ImageView)view.findViewById(R.id.redEventos);

        conten = new ArrayList<>();

        // llamando al método leer Contenido para leer los eventos existentes de la base de datos
    ...
    private void readContenido(String verificacion) {
        PerformNetworkRequest request = new PerformNetworkRequest(verificacion, null, CODE_GET_REQUEST);
        request.execute();
    }
    ...
    private void refreshContenidoList(JSONArray contenido) throws JSONException {
        ...
        mAdapter = new EventosAdapter(conten, R.layout.card_view_eventos, new EventosAdapter.OnItemClickListener() {
            @Override
