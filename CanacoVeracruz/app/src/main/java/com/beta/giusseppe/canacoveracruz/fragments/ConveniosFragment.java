...
import com.beta.giusseppe.canacoveracruz.adapters.ConveniosAdapter;
...
public class ConveniosFragment extends Fragment {
    ...
    private static final String NOTICIAS = "convenios";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_convenios, container, false);
        ...
        mRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewConvenios);
        sinRed = (ImageView)view.findViewById(R.id.redConvenio);
        conten = new ArrayList<>();

        // llamando al método leer contenido para leer convenios existentes de la base de datos
    ...
    private void refreshContenidoList(JSONArray contenido) throws JSONException {
        ...
        mAdapter = new ConveniosAdapter(conten, R.layout.card_view_convenios, new ConveniosAdapter.OnItemClickListener() {
            @Override
