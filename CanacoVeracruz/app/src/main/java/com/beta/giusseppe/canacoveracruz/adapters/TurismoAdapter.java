...
/**
 * Created by Giusseppe on 17/10/2017.
 */
...
public class TurismoAdapter extends RecyclerView.Adapter<TurismoAdapter.ViewHolder>{
    ...
    public TurismoAdapter(List<Contenido> conten, int layout, OnItemClickListener listener)
    {
        this.conten = conten;
        this.layout = layout;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ImageView ImagenFlecha;

        public ViewHolder(View v)
        {
            super(v);
            TextViewTitulo = (TextView)itemView.findViewById(R.id.cardViewTurismoTitulo);
            ImageViewPortada = (ImageView)itemView.findViewById(R.id.cardViewTurismoImagen);
            ImagenFlecha = (ImageView)itemView.findViewById(R.id.cardViewTurismoImagenNext);
        }
