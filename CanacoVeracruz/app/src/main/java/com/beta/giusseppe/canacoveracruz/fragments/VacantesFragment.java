...
import com.beta.giusseppe.canacoveracruz.activities.BolsaNotaActivity;
import com.beta.giusseppe.canacoveracruz.adapters.BolsaDeTrabajoAdapter;
...
public class VacantesFragment extends Fragment {

    private static final String BOLSA = "bolsa";
    private static final String PUBLICO = "publico";

    private static final String VISITANTE = Api.URL_READ_CONTENIDO_CATEGORIA_PRIVADO+BOLSA+Api.URL_READ_CONTENIDO_PRIVADO_ESTADO+PUBLICO;
    private static final String LOGUEADO = Api.URL_READ_CONTENIDO+BOLSA;
    String verificar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_vacates, container, false);
        ...
        mRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewBolsa);
        sinRed = (ImageView)view.findViewById(R.id.redBolsa);
        conten = new ArrayList<>();

        // llamando al método leer Contenido para leer las bolsas existentes de la base de datos
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!object.getBoolean("error")) {
                    ...
                    // refrescar la lista contenido después de cada operación
    ...
    private void refreshContenidoList(JSONArray contenido) throws JSONException {
        ...
        mAdapter = new BolsaDeTrabajoAdapter(conten, R.layout.card_view_bolsa_de_trabajo, new BolsaDeTrabajoAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(Contenido conten, int position) {

                Intent intent = new Intent(getActivity(), BolsaNotaActivity.class);
