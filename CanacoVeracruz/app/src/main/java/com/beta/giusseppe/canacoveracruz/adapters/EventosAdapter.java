...
public class EventosAdapter extends RecyclerView.Adapter<EventosAdapter.ViewHolder> {
    ...
    public EventosAdapter(List<Contenido> conten, int layout, OnItemClickListener listener)
    {
        this.conten = conten;
        this.layout = layout;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(v);
            TextViewTitulo = (TextView)itemView.findViewById(R.id.cardViewEventosTitulo);
            TextViewDescripcion = (TextView)itemView.findViewById(R.id.cardViewEventosDescripcion);
            TextViewVerMas = (TextView)itemView.findViewById(R.id.cardViewEventosVerMas);
            ImageViewPortada = (ImageView)itemView.findViewById(R.id.cardViewEventosImagen);
        }
